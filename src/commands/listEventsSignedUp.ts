	...
	for (const event of events) {
		...
		const link = event.publishedThreadId
			...
			: event.publishedChannelId && event.publishedChannelMessageId
				? `https://discord.com/channels/${event.guildId}/${event.publishedChannelId}`
				: null;
...
// 1413245061382275198 Guild ID
// /1416512741015027753 Channel ID
// /1450878545994842152 Message ID
